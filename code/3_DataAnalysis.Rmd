...
# Total number of sites & instances
  ...
  # By state
    ...
    # InstancesVsSites <- plot_grid(NumSitesByState.plot, NumInstancesByState.plot,
    #                               align = "hv",
    #                               nrow = 2)
...
```{r}
# Provider groups as percent of total providers
...
```{r}
# Provider groups as percent of total sites
...
```{r}
# Provider groups as percent of total instances
...
# Racial composition of monitored vs. unmonitored HUCS
  ...
  # Overall - percent of population comprised of each race in monitored vs. unmonitored hucs
    ...
    raceMonitoredHUCS.plot <- ggplot(raceMonitoredHUCS, 
                              ...
                              labs(title = "Racial compositon of population living within monitored and unmonitored subwatersheds", 
                                   x = "", y = "Population") +
    ...
    # percent White higher in unmonitored than monitored 
...
# Percent of each racial group living in monitored vs. unmonitored HUCS
  ...
  coverageRacialPop.plot <- ggplot(crp, aes(x = Race, y = nPpl, fill = monitoring)) + 
                            ...
                            labs(title = "Proportion of population by race living within monitored and unmonitored subwatersheds", 
                                   x = "", y = "Population") +
                            theme(axis.text.x = element_text(angle = 45, hjust = 1),
                                  legend.title = element_blank()) 
...
!!! How best to represent this? Semi-continuous, classfiied as discrete.... Ask Lauren & Kyle
...
```{r}
# Income states (mean, median, quantiles) of monitored vs. unmonitored hucs
...
```{r}
# Percent of each income bracket living in monitored vs. unmonitored HUCS
